        ...
        for user in users:
            ...
            for record in attendance_query:
                ...
                if record.time_in and record.time_out and shift_end:
                    ...
                    dynamic_status = 'Late'
                # If time_out missing and not late, dynamic_status remains Absent, working hours/overtime = 00:00:00
